...
class evolutivos_automaticos:
    ...
    def configurar_logger(self, nombre_fichero, nombre_algoritmo, version_algoritmo, semilla):
        ...
        # Configura un FileHandler para escribir los logs en un archivo
        file_handler = logging.FileHandler(log_filename)
        formatter = logging.Formatter('%(message)s')  # Ajusta el formato si es necesario
        file_handler.setFormatter(formatter)
        logger.addHandler(file_handler)

        # Asegúrate de no tener handlers asociados al stdout
